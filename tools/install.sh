...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/razz1k/ohmyzsh/master/tools/install.sh)"
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/razz1k/ohmyzsh/master/tools/install.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.com/razz1k/ohmyzsh/master/tools/install.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.githubusercontent.com/razz1k/ohmyzsh/master/tools/install.sh
#   sh install.sh
#
...
#   REPO    - name of the GitHub repo to install from (default: razz1k/ohmyzsh)
...
# or:
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/razz1k/ohmyzsh/master/tools/install.sh)" "" --unattended
#
set -e
...
setup_ohmyzsh() {
  ...
  && git fetch --recurse-submodules --depth=1 origin \
